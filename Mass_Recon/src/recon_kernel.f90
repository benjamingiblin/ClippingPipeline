        subroutine recon_kernel_g1(twoD_DATA_IN,nx,ny)
!        subroutine recon_kernel_g1(twoD_DATA_IN,nx,ny,func)
...
!          Wsmooth=func(f2)
          Wfactor=1.
          if(f2.ne.0.) Wfactor=-(-k1*k1+k2*k2)/f2
...
!        Status = DftiSetValue(my_descl_handle, DFTI_BACKWARD_SCALE, Scale)
        ...
        subroutine recon_kernel_g2(twoD_DATA_IN,nx,ny,func)
